(function () {
	...
	__vue_render__._withStripped = true;
	  ...
	  function __vue_normalize__(
	    ...
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/ItemCard.vue";
	...
	__vue_render__$1._withStripped = true;
	  ...
	  function __vue_normalize__$1(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/EmptyState.vue";
	...
	__vue_render__$2._withStripped = true;
	  ...
	  var __vue_inject_styles__$2 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-b053286a_0", { source: "\n.item-cards-container[data-v-b053286a] {\n\tmargin: 0 -15px;\n\toverflow: overlay;\n}\n", map: {"version":3,"sources":["/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/ItemCardsContainer.vue"],"names":[],"mappings":";AAyDA;CACA,gBAAA;CACA,kBAAA;CACA","file":"ItemCardsContainer.vue","sourcesContent":["<template>\n\t<div class=\"item-cards-container\">\n\t\t<empty-state\n\t\t\tv-if=\"items.length === 0\"\n\t\t\t:message=\"empty_state_message\"\n\t\t\t:action=\"empty_state_action\"\n\t\t\t:bordered=\"true\"\n\t\t\t:height=\"empty_state_height\"\n\t\t/>\n\t\t<item-card\n\t\t\tv-for=\"item in items\"\n\t\t\t:key=\"container_name + '_' +item[item_id_fieldname]\"\n\t\t\t:item=\"item\"\n\t\t\t:item_id_fieldname=\"item_id_fieldname\"\n\t\t\t:is_local=\"is_local\"\n\t\t\t:on_click=\"on_click\"\n\t\t\t:allow_clear=\"editable\"\n\t\t\t:seen=\"item.hasOwnProperty('seen') ? item.seen : true\"\n\t\t\t@remove-item=\"$emit('remove-item', item[item_id_fieldname])\"\n\t\t>\n\t\t</item-card>\n\t</div>\n</template>\n\n<script>\nimport ItemCard from './ItemCard.vue';\nimport EmptyState from './EmptyState.vue';\n\nexport default {\n\tname: 'item-cards-container',\n\tprops: {\n\t\tcontainer_name: String,\n\t\titems: Array,\n\t\titem_id_fieldname: String,\n\t\tis_local: Boolean,\n\t\ton_click: Function,\n\t\teditable: Boolean,\n\n\t\tempty_state_message: String,\n\t\tempty_state_action: Object,\n\t\tempty_state_height: Number,\n\t\tempty_state_bordered: Boolean\n\t},\n\tcomponents: {\n\t\tItemCard,\n\t\tEmptyState\n\t},\n\twatch: {\n\t\titems() {\n\t\t\t// TODO: handling doesn't work\n\t\t\tfrappe.dom.handle_broken_images($(this.$el));\n\t\t}\n\t}\n}\n</script>\n\n<style scoped>\n\t.item-cards-container {\n\t\tmargin: 0 -15px;\n\t\toverflow: overlay;\n\t}\n</style>\n"]}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$2 = "data-v-b053286a";
	  /* module identifier */
	  ...
	  function __vue_normalize__$2(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/ItemCardsContainer.vue";
	...
	__vue_render__$3._withStripped = true;
	  ...
	  function __vue_normalize__$3(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/SectionHeader.vue";
	...
	__vue_render__$4._withStripped = true;
	  ...
	  function __vue_normalize__$4(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/SearchInput.vue";
	...
	__vue_render__$5._withStripped = true;
	  ...
	  /* scoped */
	  var __vue_scope_id__$5 = "data-v-6749d55b";
	  /* module identifier */
	  ...
	  function __vue_normalize__$5(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/DetailView.vue";
	...
	__vue_render__$6._withStripped = true;
	  ...
	  function __vue_normalize__$6(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/DetailHeaderItem.vue";
	...
	__vue_render__$7._withStripped = true;
	  ...
	  function __vue_normalize__$7(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/Image.vue";
	...
	__vue_render__$8._withStripped = true;
	  ...
	  var __vue_inject_styles__$8 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-6e9e9a6c_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Home.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$8 = "data-v-6e9e9a6c";
	  /* module identifier */
	  ...
	  function __vue_normalize__$8(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Home.vue";
	...
	__vue_render__$9._withStripped = true;
	  ...
	  var __vue_inject_styles__$9 = function (inject) {
	    if (!inject) { return }
	    inject("data-v-0c21b3d8_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Search.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$9 = "data-v-0c21b3d8";
	  /* module identifier */
	  ...
	  function __vue_normalize__$9(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Search.vue";
	...
	__vue_render__$a._withStripped = true;
	  ...
	  function __vue_normalize__$a(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Category.vue";
	...
	__vue_render__$b._withStripped = true;
	  ...
	  function __vue_normalize__$b(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/SavedItems.vue";
	...
	__vue_render__$c._withStripped = true;
	  ...
	  function __vue_normalize__$c(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/PublishedItems.vue";
	...
	__vue_render__$d._withStripped = true;
	  ...
	  function __vue_normalize__$d(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/Rating.vue";
	...
	__vue_render__$e._withStripped = true;
	  ...
	  function __vue_normalize__$e(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/ReviewTimelineItem.vue";
	...
	__vue_render__$f._withStripped = true;
	  ...
	  function __vue_normalize__$f(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/ReviewArea.vue";
	...
	__vue_render__$g._withStripped = true;
	  ...
	  var __vue_inject_styles__$g = function (inject) {
	    if (!inject) { return }
	    inject("data-v-0b1f3e12_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Item.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$g = "data-v-0b1f3e12";
	  /* module identifier */
	  ...
	  function __vue_normalize__$g(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Item.vue";
	...
	__vue_render__$h._withStripped = true;
	  ...
	  var __vue_inject_styles__$h = function (inject) {
	    if (!inject) { return }
	    inject("data-v-9feb39f2_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Seller.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$h = "data-v-9feb39f2";
	  /* module identifier */
	  ...
	  function __vue_normalize__$h(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Seller.vue";
	...
	__vue_render__$i._withStripped = true;
	  ...
	  function __vue_normalize__$i(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/NotificationMessage.vue";
	...
	__vue_render__$j._withStripped = true;
	  ...
	  var __vue_inject_styles__$j = function (inject) {
	    if (!inject) { return }
	    inject("data-v-782eb5d0_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Publish.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$j = "data-v-782eb5d0";
	  /* module identifier */
	  ...
	  function __vue_normalize__$j(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Publish.vue";
	...
	__vue_render__$k._withStripped = true;
	  ...
	  function __vue_normalize__$k(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/ItemListCard.vue";
	...
	__vue_render__$l._withStripped = true;
	  ...
	  function __vue_normalize__$l(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Buying.vue";
	...
	__vue_render__$m._withStripped = true;
	  ...
	  function __vue_normalize__$m(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Selling.vue";
	...
	__vue_render__$n._withStripped = true;
	  ...
	  function __vue_normalize__$n(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/components/CommentInput.vue";
	...
	__vue_render__$o._withStripped = true;
	  ...
	  function __vue_normalize__$o(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Messages.vue";
	...
	__vue_render__$p._withStripped = true;
	  ...
	  var __vue_inject_styles__$p = function (inject) {
	    if (!inject) { return }
	    inject("data-v-2514f850_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"Profile.vue"}, media: undefined });

	  };
	  /* scoped */
	  var __vue_scope_id__$p = "data-v-2514f850";
	  /* module identifier */
	  ...
	  function __vue_normalize__$p(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/Profile.vue";
	...
	__vue_render__$q._withStripped = true;
	  ...
	  function __vue_normalize__$q(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/pages/NotFound.vue";
	...
	__vue_render__$r._withStripped = true;
	  ...
	  function __vue_normalize__$r(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/PageContainer.vue";
	...
	__vue_render__$s._withStripped = true;
	  ...
	  function __vue_normalize__$s(
	    ...
	    // For security concerns, we use only base name in production mode.
	    component.__file = "/opt/erpnext/frappe-training/apps/erpnext/erpnext/public/js/hub/Sidebar.vue";
